...
<body bgcolor="#1e1f33">
				...
				<a class="waves-effect waves-light btn modal-trigger" href="#modal1">Buy</a>
			  	...
			  	<div id="modal1" class="modal">
			    	...
			    	<div class="modal-footer">
			      		<a   class="waves-effect waves-light btn modal-action modal-close">Submit</a>
			    	</div>
					</div>
				</div>
  				</div>
		...
		<section class="section container">
			...
			<div class="row center-align">
				<a class="waves-effect waves-light btn modal-trigger" href="#modal2">Buy</a>
			</div>
														<!-- Modal Structure 2 -->
		...
		<section class="section container">
			...
			<div class="row center-align">
				<a class="waves-effect waves-light btn modal-trigger" href="#modal3">Buy</a>
			</div>
														<!-- Modal Structure 3 -->
